...
#set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { INPUT_DRIVER[0] }]; #IO_L24N_T3_RS0_15 Sch=sw[0] # reemplazado por system_io_wrapper
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { SW0 }]; #IO_L24N_T3_RS0_15 Sch=sw[0] GAME_RESET
#set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { INPUT_DRIVER[1] }]; #IO_L3N_T0_DQS_EMCCLK_14 Sch=sw[1] # reemplazado por system_io_wrapper
#set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { INPUT_DRIVER[2] }]; #IO_L6N_T0_D08_VREF_14 Sch=sw[2] # reemplazado por system_io_wrapper
#set_property -dict { PACKAGE_PIN R15   IOSTANDARD LVCMOS33 } [get_ports { INPUT_DRIVER[3] }]; #IO_L13N_T2_MRCC_14 Sch=sw[3] # reemplazado por system_io_wrapper
#set_property -dict { PACKAGE_PIN R17   IOSTANDARD LVCMOS33 } [get_ports { INPUT_DRIVER[4] }]; #IO_L12N_T1_MRCC_14 Sch=sw[4] # reemplazado por system_io_wrapper
#set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports { INPUT_DRIVER[5] }]; #IO_L7N_T1_D10_14 Sch=sw[5] # reemplazado por system_io_wrapper
#set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports { INPUT_DRIVER[6] }]; #IO_L17N_T2_A13_D29_14 Sch=sw[6] # reemplazado por system_io_wrapper
#set_property -dict { PACKAGE_PIN R13   IOSTANDARD LVCMOS33 } [get_ports { INPUT_DRIVER[7] }]; #IO_L5N_T0_D07_14 Sch=sw[7] # reemplazado por system_io_wrapper
...
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { BTNC }]; #IO_L9P_T1_DQS_14 Sch=btnc START
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { BTNU }]; #IO_L4N_T0_D05_14 Sch=btnu LEFT_UP
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { BTNL }]; #IO_L12P_T1_MRCC_14 Sch=btnl LEFT_DOWN
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { BTNR }]; #IO_L10N_T1_D15_14 Sch=btnr RIGHT_UP
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { BTND }]; #IO_L9N_T1_DQS_D13_14 Sch=btnd RIGHT_DOWN
...
# UARTLite para depuración. C4 es la línea TXD del puente USB-UART hacia la FPGA,
# por eso se conecta al RX del periférico. D4 es la línea que la FPGA transmite al puente.
set_property -dict { PACKAGE_PIN C4    IOSTANDARD LVCMOS33 } [get_ports { UART_0_rxd }]; #IO_L7P_T1_AD6P_35 Sch=uart_txd_in
set_property -dict { PACKAGE_PIN D4    IOSTANDARD LVCMOS33 } [get_ports { UART_0_txd }]; #IO_L11N_T1_SRCC_35 Sch=uart_rxd_out
